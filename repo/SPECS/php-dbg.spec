...
# -dbg -dbg
#  conflict/opposite of -dbg
# --enable-debug   --enable-debug (or not)
...
License: PHP License
Provides: mod_php-dbg = %{version}-%{release}
Requires: php-dbg-common = %{version}-%{release}
...
Requires: php-dbg-common = %{version}-%{release}
Provides: php-dbg-cgi = %{version}-%{release}
Conflicts: php-cgi
...
Requires: php-dbg-common = %{version}-%{release}
Provides: php-dbg-cli = %{version}-%{release}
Conflicts: php-cli
...
Requires: php-dbg = %{version}-%{release}
Requires: libxml2 < 2.7.0, curl, openssl, expat
Provides: php-api = %{apiver}, php-zend-api = %{zendver}
Provides: php-dbg-ctype, php-dbg-curl, php-dbg-date
Provides: php-dbg-ftp, php-dbg-hash, php-dbg-iconv, php-dbg-libxml
Provides: php-dbg-openssl, php-dbg-pcre, php-dbg-mcrypt, php-dbg-pdo
Provides: php-dbg-reflection, php-dbg-session, php-dbg-shmop, php-dbg-simplexml
Provides: php-dbg-spl, php-dbg-sysvsem, php-dbg-sysvshm, php-dbg-sysvmsg, php-dbg-tokenizer
Provides: php-dbg-zlib, php-dbg-json
Obsoletes: php-dbg-openssl, php-dbg-curl, php-dbg-mhash
Obsoletes: php-dbg-pecl-json, php-pecl-fileinfo
Conflicts: php-common

%description common
The php-dbg-common package contains files used by both the php
package and the php-dbg-cli package.

%package devel
Group: Development/Libraries
Summary: Files needed for building PHP extensions
Requires: php-dbg = %{version}-%{release}, autoconf213, automake
Conflicts: php-devel

%description devel
The php-dbg-devel package contains the files needed for building PHP
...
Requires: php-dbg-common = %{version}-%{release}, enchant
BuildRequires: enchant-devel
Conflicts: php-enchant

%description enchant
php-dbg-enchant is the PHP binding for the Enchant library. Enchant steps in to 
...
Requires: php-dbg-common = %{version}-%{release}, libc-client, openssl
...
%description imap
The php-dbg-imap package enables functions for the IMAP protocol, as well 
...
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}
Provides: php_database, php-dbg-mysqli
Obsoletes: mod_php3-mysql, stronghold-php-mysql
Conflicts: php-mysql

%description mysql
The php-dbg-mysql package contains a dynamic shared object that will add
...
Requires: php-dbg-common = %{version}-%{release}, libtidy
BuildRequires: libtidy-devel
Conflicts: php-tidy

%description tidy
php-dbg-tidy is a binding for the Tidy HTML clean and repair utility which 
...
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}, openldap
Obsoletes: mod_php3-ldap, stronghold-php-ldap
BuildRequires: cyrus-sasl-devel, openldap-devel, openssl-devel
Conflicts: php-ldap

%description ldap
The php-dbg-ldap package is a dynamic shared object (DSO) for the Apache
...
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}, php-dbg-pdo, oracle-instantclient11.1-basic
Provides: php_database
BuildRequires: krb5-devel, openssl-devel, oracle-instantclient11.1-devel
Conflicts: php-oci8

%description oci8
The php-dbg-oci8 package includes a dynamic shared object (DSO) that can
...
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}, php-dbg-pdo, postgresql
Provides: php_database
...
%description pgsql
The php-dbg-pgsql package includes a dynamic shared object (DSO) that can
...
%package odbc
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}, php-dbg-pdo, unixODBC
...
%description odbc
The php-dbg-odbc package contains a dynamic shared object that will add
...
%package mssql
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}, php-dbg-pdo, freetds
...
%description mssql
The php-dbg-mssql package contains a dynamic shared object that will add
database support for MS SQL to PHP. 

%package snmp
Summary: A module for PHP applications that query SNMP-managed devices.
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}, net-snmp
BuildRequires: net-snmp-devel
Conflicts: php-dbg-snmp

%description snmp
The php-dbg-snmp package contains a dynamic shared object that will add
...
%description dba
The php-dbg-dba package contains a dynamic shared object that will add
support for using the DBA database abstraction layer to PHP.

%package readline
Summary: A module for PHP applications for using the GNU Readline library
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}, readline
BuildRequires: readline-devel
Conflicts: php-readline

%description readline
The php-dbg-readline package contains functions that provide editable command 
...
%description soap
The php-dbg-soap package contains a dynamic shared object that will add
...
Conflicts: php-xmlrpc

%description xmlrpc
The php-dbg-xmlrpc package contains a dynamic shared object that will add
...
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}
Conflicts: php-mbstring

%description mbstring
The php-dbg-mbstring package contains a dynamic shared object that will add
...
%description gd
The php-dbg-gd package contains a dynamic shared object that will add
...
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}
Conflicts: php-bcmath

%description bcmath
The php-dbg-bcmath package contains a dynamic shared object that will add
support for using the bcmath library to PHP.

%package mcrypt
Summary: A module for PHP applications for using the mcrypt library
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}, libmcrypt
BuildRequires: libmcrypt-devel
Conflicts: php-mcrypt

%description mcrypt
The php-dbg-mcrypt package contains a dynamic shared object that will add
...
%description exif
The php-dbg-exif package contains a dynamic shared object that will add
support for using the EXIF functions to PHP.

%package bz2
Summary: A module for PHP applications for using the bzip2 functions
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}, bzip2
BuildRequires: bzip2-devel
Conflicts: php-bz2

%description bz2
The php-dbg-bz2 package contains a dynamic shared object that will add
support for using the bzip2 functions to PHP.

%package gmp
Summary: A module for PHP applications for using the gmp functions
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}, gmp
BuildRequires: gmp-devel
Conflicts: php-gmp

%description gmp
The php-dbg-gmp package contains a dynamic shared object that will add
...
%description wddx
The php-dbg-wddx package contains a dynamic shared object that will add
...
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}
Conflicts: php-calendar

%description calendar
The php-dbg-calendar package contains a dynamic shared object that will add
support for using the calendar functions to PHP.

%package gettext
Summary: A module for PHP applications for using the gettext functions
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}, gettext
BuildRequires: gettext-devel
Conflicts: php-gettext

%description gettext
The php-dbg-gettext package contains a dynamic shared object that will add
support for using the gettext functions to PHP.

%package xsl
Summary: A module for PHP applications for using the xsl functions
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}, libxslt, libxml2
BuildRequires: libxslt-devel libxml2-devel
Conflicts: php-xsl

%description xsl
The php-dbg-xsl package contains a dynamic shared object that will add
support for using the xsl functions to PHP.

%package zip
Summary: A module for PHP applications for using the Zip functions
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}, zlib
BuildRequires: zlib-devel
Conflicts: php-zip

%description zip
The php-dbg-zip package contains a dynamic shared object that will add
support for using the zip functions to PHP.

%package intl
Summary: A module for PHP applications for using the intl functions
Group: Development/Languages
Requires: php-dbg-common = %{version}-%{release}, libicu
BuildRequires: libicu-devel
Conflicts: php-intl

%description intl
The php-dbg-intl package contains a dynamic shared object that will add
...
%description pcntl
The php-dbg-pcntl package contains a dynamic shared object that will add
...
mkdir build-cli-dbg build-cgi-dbg build-apache-dbg
...
pushd build-cli-dbg
build --enable-cli --disable-cgi --enable-debug \
    --with-pear \
...
build --enable-cgi --disable-cli --without-pear --enable-debug \
...
pushd build-apache-dbg
# mysql shared extensions needed to trigger inclusion of mysqlnd internally
build --with-apxs2=%{_sbindir}/apxs --disable-cli --without-pear --enable-debug \
...
install -m 755 build-apache-dbg/libs/libphp5.so $RPM_BUILD_ROOT%{_libdir}/httpd/modules
...
rm -rf $RPM_BUILD_ROOT%{_libdir}/php/extensions/debug-non-zts-20090626/*.a
...
%config %{_sysconfdir}/php.mod.d/php.ini
%config %{_sysconfdir}/php.mod.d/php-dev.ini
...
%config %{_sysconfdir}/php.cli.d/php.ini
%config %{_sysconfdir}/php.cli.d/php-dev.ini
...
%defattr(-,root,root)
%{_bindir}/php-cgi
%config %{_sysconfdir}/php.cgi.d/php.ini
%config %{_sysconfdir}/php.cgi.d/php-dev.ini
...
%files enchant
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/enchant.so
...
%files imap
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/imap.so
...
%files oci8
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/oci8.so
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/pdo_oci.so
...
%files pgsql
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/pgsql.so
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/pdo_pgsql.so
...
%files mysql
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/mysql.so
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/mysqli.so
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/pdo_mysql.so
...
%files odbc
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/odbc.so
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/pdo_odbc.so
...
%files tidy
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/tidy.so
...
%files mssql
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/mssql.so
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/pdo_dblib.so
...
%files readline
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/readline.so
...
%files ldap
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/ldap.so
...
%files snmp
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/snmp.so
...
%files dba
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/dba.so
...
%files soap
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/soap.so
...
%files xmlrpc
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/xmlrpc.so
...
%files mbstring
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/mbstring.so
...
%files gd
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/gd.so
...
%files bcmath
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/bcmath.so
...
%files mcrypt
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/mcrypt.so
...
%files exif
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/exif.so
...
%files bz2
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/bz2.so
...
%files gmp
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/gmp.so
...
%files wddx
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/wddx.so
...
%files calendar
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/calendar.so
...
%files gettext
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/gettext.so
...
%files xsl
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/xsl.so
...
%files zip
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/zip.so
...
%files intl
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/intl.so
...
%files pcntl
%attr(755,root,root) %{_libdir}/php/extensions/debug-non-zts-20090626/pcntl.so
