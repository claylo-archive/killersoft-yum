...
Requires: %{name} = %{version}-%{release}, openssl-devel, libssh2-devel zlib-devel
...
#    %{buildroot}%{_sysconfdir}/cacerts/cacert.pem
%makeinstall
...
%{_mandir}/man1/curl.1*
%{_libdir}/libcurl.so.*
#%{_sysconfdir}/cacerts/cacert.pem
...
%changelog
* Mon Apr 21 2008 Rob Richards <rob@mashery.com> - 7.18.1
- update to curl-7.18.1
...
* Mon Jul 22 2002 Trond Eivind Glomsrod <teg@redhat.com> 7.9.8-1
- 7.9.8 (# 69473)
...
* Thu May 16 2002 Trond Eivind Glomsrod <teg@redhat.com> 7.9.7-1
- 7.9.7

* Wed Apr 24 2002 Trond Eivind Glomsrod <teg@redhat.com> 7.9.6-1
- 7.9.6

* Thu Mar 21 2002 Trond Eivind Glomsrod <teg@redhat.com> 7.9.5-2
- Stop the curl-config script from printing -I/usr/include 
  and -L/usr/lib (#59497)

* Fri Mar  8 2002 Trond Eivind Glomsrod <teg@redhat.com> 7.9.5-1
- 7.9.5

* Tue Feb 26 2002 Trond Eivind Glomsrod <teg@redhat.com> 7.9.3-2
- Rebuild
...
* Wed Jan  9 2002 Trond Eivind Glomsrod <teg@redhat.com> 7.9.2-1
- 7.9.2
